DROP TABLE IF EXISTS `noob_order`;
CREATE TABLE `noob_order` (
...
DROP TABLE IF EXISTS `noob_order_item`;
CREATE TABLE `noob_order_item` (
...
DROP TABLE IF EXISTS `noob_product`;
CREATE TABLE `noob_product` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `noob_member`;
CREATE TABLE `noob_member` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
